...
import com.ksoko.Model.Cart;
import com.ksoko.Prevalent.Prevalent;
import com.ksoko.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("shipped"))
                    {
                        ...
                        Toast.makeText(CartActivity.this, "You can purchase more products, once you received your final order.",
